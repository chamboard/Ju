...
gboolean button19_clicked_cb(GtkWidget * p_wid, gpointer p_data) {
	SGlobalData *data =(SGlobalData*) p_data;
	GtkScale* scale=GTK_SCALE(gtk_builder_get_object(data->builder,"scale2"));
	GtkEntry* entry=GTK_ENTRY(gtk_builder_get_object(data->builder,"entry2"));
	uint8_t value=0;
...
gboolean button20_clicked_cb(GtkWidget * p_wid, gpointer p_data) {
	SGlobalData *data =(SGlobalData*) p_data;
	GtkScale* scale=GTK_SCALE(gtk_builder_get_object(data->builder,"scale3"));
	GtkEntry* entry=GTK_ENTRY(gtk_builder_get_object(data->builder,"entry3"));
	uint8_t value=0;
...
gboolean button21_clicked_cb(GtkWidget * p_wid, gpointer p_data) {
	SGlobalData *data =(SGlobalData*) p_data;
	GtkScale* scale=GTK_SCALE(gtk_builder_get_object(data->builder,"scale4"));
	GtkEntry* entry=GTK_ENTRY(gtk_builder_get_object(data->builder,"entry4"));
	uint8_t value=0;
...
gboolean button22_clicked_cb(GtkWidget * p_wid, gpointer p_data) {
	SGlobalData *data =(SGlobalData*) p_data;
	GtkScale* scale=GTK_SCALE(gtk_builder_get_object(data->builder,"scale5"));
	GtkEntry* entry=GTK_ENTRY(gtk_builder_get_object(data->builder,"entry5"));
	uint8_t value=0;
...
gboolean button23_clicked_cb(GtkWidget * p_wid, gpointer p_data) {
	SGlobalData *data =(SGlobalData*) p_data;
	GtkScale* scale=GTK_SCALE(gtk_builder_get_object(data->builder,"scale6"));
	GtkEntry* entry=GTK_ENTRY(gtk_builder_get_object(data->builder,"entry6"));
	uint8_t value=0;
...
gboolean button24_clicked_cb(GtkWidget * p_wid, gpointer p_data) {
	SGlobalData *data =(SGlobalData*) p_data;
	GtkScale* scale=GTK_SCALE(gtk_builder_get_object(data->builder,"scale7"));
	GtkEntry* entry=GTK_ENTRY(gtk_builder_get_object(data->builder,"entry7"));
	uint8_t value=0;
...
gboolean button25_clicked_cb(GtkWidget * p_wid, gpointer p_data) {
	SGlobalData *data =(SGlobalData*) p_data;
	GtkScale* scale=GTK_SCALE(gtk_builder_get_object(data->builder,"scale8"));
	GtkEntry* entry=GTK_ENTRY(gtk_builder_get_object(data->builder,"entry8"));
	uint8_t value=0;
...
gboolean button26_clicked_cb(GtkWidget * p_wid, gpointer p_data) {
	SGlobalData *data =(SGlobalData*) p_data;
	GtkScale* scale=GTK_SCALE(gtk_builder_get_object(data->builder,"scale9"));
	GtkEntry* entry=GTK_ENTRY(gtk_builder_get_object(data->builder,"entry9"));
	uint8_t value=0;
...
gboolean button27_clicked_cb(GtkWidget * p_wid, gpointer p_data) {
	SGlobalData *data =(SGlobalData*) p_data;
	GtkScale* scale=GTK_SCALE(gtk_builder_get_object(data->builder,"scale10"));
	GtkEntry* entry=GTK_ENTRY(gtk_builder_get_object(data->builder,"entry10"));
	uint8_t value=0;
...
gboolean button28_clicked_cb(GtkWidget * p_wid, gpointer p_data) {
	SGlobalData *data =(SGlobalData*) p_data;
	GtkScale* scale=GTK_SCALE(gtk_builder_get_object(data->builder,"scale11"));
	GtkEntry* entry=GTK_ENTRY(gtk_builder_get_object(data->builder,"entry11"));
	uint8_t value=0;
...
gboolean button29_clicked_cb(GtkWidget * p_wid, gpointer p_data) {
	SGlobalData *data =(SGlobalData*) p_data;
	GtkScale* scale=GTK_SCALE(gtk_builder_get_object(data->builder,"scale12"));
	GtkEntry* entry=GTK_ENTRY(gtk_builder_get_object(data->builder,"entry12"));
	uint8_t value=0;
...
gboolean button30_clicked_cb(GtkWidget * p_wid, gpointer p_data) {
	SGlobalData *data =(SGlobalData*) p_data;
	GtkScale* scale=GTK_SCALE(gtk_builder_get_object(data->builder,"scale13"));
	GtkEntry* entry=GTK_ENTRY(gtk_builder_get_object(data->builder,"entry13"));
	uint8_t value=0;
...
gboolean button31_clicked_cb(GtkWidget * p_wid, gpointer p_data) {
	SGlobalData *data =(SGlobalData*) p_data;
	GtkScale* scale=GTK_SCALE(gtk_builder_get_object(data->builder,"scale14"));
	GtkEntry* entry=GTK_ENTRY(gtk_builder_get_object(data->builder,"entry14"));
	uint8_t value=0;
...
gboolean button32_clicked_cb(GtkWidget * p_wid, gpointer p_data) {
	SGlobalData *data =(SGlobalData*) p_data;
	GtkScale* scale=GTK_SCALE(gtk_builder_get_object(data->builder,"scale15"));
	GtkEntry* entry=GTK_ENTRY(gtk_builder_get_object(data->builder,"entry15"));
	uint8_t value=0;
...
gboolean button33_clicked_cb(GtkWidget * p_wid, gpointer p_data) {
	SGlobalData *data =(SGlobalData*) p_data;
	GtkScale* scale=GTK_SCALE(gtk_builder_get_object(data->builder,"scale16"));
	GtkEntry* entry=GTK_ENTRY(gtk_builder_get_object(data->builder,"entry16"));
	uint8_t value=0;
...
gboolean button34_clicked_cb(GtkWidget * p_wid, gpointer p_data) {
	SGlobalData *data =(SGlobalData*) p_data;
...
gboolean comboboxtext2_changed_cb(GtkWidget * p_wid, gpointer p_data) {
	...
	button[0]=GTK_BUTTON(gtk_builder_get_object(data->builder,"button35"));
	...
	entry[14]=GTK_ENTRY(gtk_builder_get_object(data->builder,"entry15"));
	entry[15]=GTK_ENTRY(gtk_builder_get_object(data->builder,"entry16"));*/
	//printf("active : %d\n",16*(gtk_combo_box_get_active(GTK_COMBO_BOX(p_wid))-1)+4);
...
void releaseTogglesButtons (GtkWidget * p_wid, gpointer p_data) {
	SGlobalData *data =(SGlobalData*) p_data;
	...
	//togglebutton[15]=GTK_TOGGLE_BUTTON(gtk_builder_get_object(data->builder,"togglebutton17"));
...
void releaseTogglesButtons2 (GtkWidget * p_wid, gpointer p_data) {
	SGlobalData *data =(SGlobalData*) p_data;
	GtkToggleButton* togglebutton[16]={NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL};
	uint8_t i=0;
	...
	//if (gtk_toggle_button_get_active(GTK_TOGGLE_BUTTON(p_wid))) {
		for (i=0;i<15;i++) {
			//if (p_wid!=GTK_WIDGET(togglebutton[i])) 
			gtk_toggle_button_set_active(togglebutton[i],FALSE);
		}
	//}
}

void releaseTogglesButtons3 (GtkWidget * p_wid, gpointer p_data) {
	SGlobalData *data =(SGlobalData*) p_data;
	GtkToggleButton* togglebutton[16]={NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL};
	uint8_t i=0;
...
void releaseTogglesButtons4 (GtkWidget * p_wid, gpointer p_data) {
	SGlobalData *data =(SGlobalData*) p_data;
	GtkToggleButton* togglebutton[16]={NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL};
	uint8_t i=0;
...
void togglebutton2_toggled_cb (GtkWidget * p_wid, gpointer p_data) {
	SGlobalData *data =(SGlobalData*) p_data;
	GtkLabel* label=NULL;
...
void togglebutton3_toggled_cb (GtkWidget * p_wid, gpointer p_data) {
	SGlobalData *data =(SGlobalData*) p_data;
	GtkLabel* label=NULL;
	GtkComboBoxText* comboboxtext=NULL;
	comboboxtext=GTK_COMBO_BOX_TEXT(gtk_builder_get_object(data->builder,"comboboxtext2"));
...
void togglebutton4_toggled_cb (GtkWidget * p_wid, gpointer p_data) {
	SGlobalData *data =(SGlobalData*) p_data;
	GtkLabel* label=NULL;
	GtkComboBoxText* comboboxtext=NULL;
	comboboxtext=GTK_COMBO_BOX_TEXT(gtk_builder_get_object(data->builder,"comboboxtext2"));
...
void togglebutton5_toggled_cb (GtkWidget * p_wid, gpointer p_data) {
	SGlobalData *data =(SGlobalData*) p_data;
	GtkLabel* label=NULL;
	GtkComboBoxText* comboboxtext=NULL;
	comboboxtext=GTK_COMBO_BOX_TEXT(gtk_builder_get_object(data->builder,"comboboxtext2"));
...
void togglebutton6_toggled_cb (GtkWidget * p_wid, gpointer p_data) {
	SGlobalData *data =(SGlobalData*) p_data;
	GtkLabel* label=NULL;
	GtkComboBoxText* comboboxtext=NULL;
	comboboxtext=GTK_COMBO_BOX_TEXT(gtk_builder_get_object(data->builder,"comboboxtext2"));
...
void togglebutton7_toggled_cb (GtkWidget * p_wid, gpointer p_data) {
	SGlobalData *data =(SGlobalData*) p_data;
	GtkLabel* label=NULL;
	GtkComboBoxText* comboboxtext=NULL;
	comboboxtext=GTK_COMBO_BOX_TEXT(gtk_builder_get_object(data->builder,"comboboxtext2"));
...
void togglebutton8_toggled_cb (GtkWidget * p_wid, gpointer p_data) {
	SGlobalData *data =(SGlobalData*) p_data;
	GtkLabel* label=NULL;
	GtkComboBoxText* comboboxtext=NULL;
	comboboxtext=GTK_COMBO_BOX_TEXT(gtk_builder_get_object(data->builder,"comboboxtext2"));
...
void togglebutton9_toggled_cb (GtkWidget * p_wid, gpointer p_data) {
	SGlobalData *data =(SGlobalData*) p_data;
	GtkLabel* label=NULL;
	GtkComboBoxText* comboboxtext=NULL;
	comboboxtext=GTK_COMBO_BOX_TEXT(gtk_builder_get_object(data->builder,"comboboxtext2"));
...
void togglebutton10_toggled_cb (GtkWidget * p_wid, gpointer p_data) {
	SGlobalData *data =(SGlobalData*) p_data;
	GtkLabel* label=NULL;
	GtkComboBoxText* comboboxtext=NULL;
	comboboxtext=GTK_COMBO_BOX_TEXT(gtk_builder_get_object(data->builder,"comboboxtext2"));
...
void togglebutton11_toggled_cb (GtkWidget * p_wid, gpointer p_data) {
	SGlobalData *data =(SGlobalData*) p_data;
	GtkLabel* label=NULL;
	GtkComboBoxText* comboboxtext=NULL;
	comboboxtext=GTK_COMBO_BOX_TEXT(gtk_builder_get_object(data->builder,"comboboxtext2"));
...
void togglebutton12_toggled_cb (GtkWidget * p_wid, gpointer p_data) {
	SGlobalData *data =(SGlobalData*) p_data;
	GtkLabel* label=NULL;
	GtkComboBoxText* comboboxtext=NULL;
	comboboxtext=GTK_COMBO_BOX_TEXT(gtk_builder_get_object(data->builder,"comboboxtext2"));
...
void togglebutton13_toggled_cb (GtkWidget * p_wid, gpointer p_data) {
	SGlobalData *data =(SGlobalData*) p_data;
	GtkLabel* label=NULL;
	GtkComboBoxText* comboboxtext=NULL;
	comboboxtext=GTK_COMBO_BOX_TEXT(gtk_builder_get_object(data->builder,"comboboxtext2"));
...
void togglebutton14_toggled_cb (GtkWidget * p_wid, gpointer p_data) {
	SGlobalData *data =(SGlobalData*) p_data;
	GtkLabel* label=NULL;
	GtkComboBoxText* comboboxtext=NULL;
	comboboxtext=GTK_COMBO_BOX_TEXT(gtk_builder_get_object(data->builder,"comboboxtext2"));
...
void togglebutton15_toggled_cb (GtkWidget * p_wid, gpointer p_data) {
	SGlobalData *data =(SGlobalData*) p_data;
	GtkLabel* label=NULL;
	GtkComboBoxText* comboboxtext=NULL;
	comboboxtext=GTK_COMBO_BOX_TEXT(gtk_builder_get_object(data->builder,"comboboxtext2"));
...
void togglebutton16_toggled_cb (GtkWidget * p_wid, gpointer p_data) {
	SGlobalData *data =(SGlobalData*) p_data;
	GtkLabel* label=NULL;
	GtkComboBoxText* comboboxtext=NULL;
	comboboxtext=GTK_COMBO_BOX_TEXT(gtk_builder_get_object(data->builder,"comboboxtext2"));
...
void button35_clicked_cb (GtkWidget * p_wid, gpointer p_data) {
	...
	entry[15]=GTK_ENTRY(gtk_builder_get_object(data->builder,"entry16"));
	comboboxtext=GTK_COMBO_BOX_TEXT(gtk_builder_get_object(data->builder,"comboboxtext2"));
	offset=16*(gtk_combo_box_get_active(GTK_COMBO_BOX(comboboxtext))-1)+4;
	//printf("offset = %d\n",offset);
	if (*(gint*)(data->user_data+8)==-1) {															// If deamonized access mode (mySlot!=-1).
		* (gint*)(data->user_data+20)+=CHAND_addr(*(gint*)(data->user_data+12),*(gint*)(data->user_data+40),offset,_DEXEC_COMPLETE);			//
		*(gint*)(data->user_data+20)+=CHAND_getBytes(*(gint*)(data->user_data+12),*(gint*)(data->user_data+40),16,&myRXBuffer[0],_DEXEC_COMPLETE);// Write PWM_SOURCE value @ 0x119.
	}
	else {
...
void button36_clicked_cb (GtkWidget * p_wid, gpointer p_data) {
	...
	myTXBuffer[16]=16*(gtk_combo_box_get_active(GTK_COMBO_BOX(comboboxtext))-1)+4;
	//printf("offset : %d\n",myTXBuffer[16]);
	//t[16]=(char*)gtk_entry_get_text(entry[16]);
	//strcpy(t2,t[16]);
	//sscanf((const char*)t[16],"%x",(int*)&myTXBuffer[16]);
...
void togglebutton17_toggled_cb(GtkWidget * p_wid, gpointer p_data) {
	SGlobalData *data =(SGlobalData*) p_data;
...
void togglebutton18_toggled_cb(GtkWidget * p_wid, gpointer p_data) {
	SGlobalData *data =(SGlobalData*) p_data;
	GtkLabel* label=GTK_LABEL(gtk_builder_get_object(data->builder,"label2"));
...
void togglebutton19_toggled_cb(GtkWidget * p_wid, gpointer p_data) {
	SGlobalData *data =(SGlobalData*) p_data;
	GtkLabel* label=GTK_LABEL(gtk_builder_get_object(data->builder,"label2"));
...
void togglebutton20_toggled_cb(GtkWidget * p_wid, gpointer p_data) {
	SGlobalData *data =(SGlobalData*) p_data;
	GtkLabel* label=GTK_LABEL(gtk_builder_get_object(data->builder,"label2"));
...
void togglebutton21_toggled_cb(GtkWidget * p_wid, gpointer p_data) {
	SGlobalData *data =(SGlobalData*) p_data;
	GtkLabel* label=GTK_LABEL(gtk_builder_get_object(data->builder,"label2"));
...
void togglebutton22_toggled_cb(GtkWidget * p_wid, gpointer p_data) {
	SGlobalData *data =(SGlobalData*) p_data;
	GtkLabel* label=GTK_LABEL(gtk_builder_get_object(data->builder,"label2"));
...
void togglebutton23_toggled_cb(GtkWidget * p_wid, gpointer p_data) {
	SGlobalData *data =(SGlobalData*) p_data;
	GtkLabel* label=GTK_LABEL(gtk_builder_get_object(data->builder,"label2"));
...
void togglebutton24_toggled_cb(GtkWidget * p_wid, gpointer p_data) {
	SGlobalData *data =(SGlobalData*) p_data;
	GtkLabel* label=GTK_LABEL(gtk_builder_get_object(data->builder,"label2"));
...
void togglebutton25_toggled_cb(GtkWidget * p_wid, gpointer p_data) {
	SGlobalData *data =(SGlobalData*) p_data;
	GtkLabel* label=GTK_LABEL(gtk_builder_get_object(data->builder,"label2"));
...
void togglebutton26_toggled_cb(GtkWidget * p_wid, gpointer p_data) {
	SGlobalData *data =(SGlobalData*) p_data;
	GtkLabel* label=GTK_LABEL(gtk_builder_get_object(data->builder,"label2"));
...
void togglebutton27_toggled_cb(GtkWidget * p_wid, gpointer p_data) {
	SGlobalData *data =(SGlobalData*) p_data;
	GtkLabel* label=GTK_LABEL(gtk_builder_get_object(data->builder,"label2"));
...
void togglebutton28_toggled_cb(GtkWidget * p_wid, gpointer p_data) {
	SGlobalData *data =(SGlobalData*) p_data;
	GtkLabel* label=GTK_LABEL(gtk_builder_get_object(data->builder,"label2"));
...
void togglebutton29_toggled_cb(GtkWidget * p_wid, gpointer p_data) {
	SGlobalData *data =(SGlobalData*) p_data;
	GtkLabel* label=GTK_LABEL(gtk_builder_get_object(data->builder,"label2"));
...
void togglebutton30_toggled_cb(GtkWidget * p_wid, gpointer p_data) {
	SGlobalData *data =(SGlobalData*) p_data;
	GtkLabel* label=GTK_LABEL(gtk_builder_get_object(data->builder,"label2"));
...
void togglebutton31_toggled_cb(GtkWidget * p_wid, gpointer p_data) {
	SGlobalData *data =(SGlobalData*) p_data;
	GtkLabel* label=GTK_LABEL(gtk_builder_get_object(data->builder,"label2"));
