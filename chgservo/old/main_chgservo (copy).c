...
gboolean scale16_value_changed_cb(GtkWidget * p_wid, gpointer p_data) {
	...
	if (*(gint*)(data->user_data+8)==-1) {															// If deamonized access mode (mySlot!=-1).
		*(gint*)(data->user_data+20)+=CHAND_setPRECISE(*(gint*)(data->user_data+12),_IO24,0x117,_DEXEC_COMPLETE);
		*(gint*)(data->user_data+20)+=CHAND_writeBYTES(*(gint*)(data->user_data+12),_IO24,1,(uint8_t*)&value2,_DEXEC_COMPLETE);
	}
	else {																							// Else direct access mode.
		*(gint*)(data->user_data+20)+=CHAN_addr(_IO24,0x117);
		*(gint*)(data->user_data+20)+=CHAN_setByte(_IO24,(uint8_t)value);
	}
	return TRUE;
}
...
gboolean scale15_value_changed_cb(GtkWidget * p_wid, gpointer p_data) {
	...
	value2=(uint8_t)value;
	if (*(gint*)(data->user_data+8)==-1) {															// If deamonized access mode (mySlot!=-1).
		*(gint*)(data->user_data+20)+=CHAND_setPRECISE(*(gint*)(data->user_data+12),_IO24,0x116,_DEXEC_COMPLETE);
		*(gint*)(data->user_data+20)+=CHAND_writeBYTES(*(gint*)(data->user_data+12),_IO24,1,(uint8_t*)&value2,_DEXEC_COMPLETE);
	}
	else {
		*(gint*)(data->user_data+20)+=CHAN_addr(_IO24,0x116);
		*(gint*)(data->user_data+20)+=CHAN_setByte(_IO24,(uint8_t)value);
	}
	return TRUE;
}
...
gboolean scale14_value_changed_cb(GtkWidget * p_wid, gpointer p_data) {
	...
	value2=(uint8_t)value;
	if (*(gint*)(data->user_data+8)==-1) {															// If deamonized access mode (mySlot!=-1).
		*(gint*)(data->user_data+20)+=CHAND_setPRECISE(*(gint*)(data->user_data+12),_IO24,0x115,_DEXEC_COMPLETE);
		*(gint*)(data->user_data+20)+=CHAND_writeBYTES(*(gint*)(data->user_data+12),_IO24,1,(uint8_t*)&value2,_DEXEC_COMPLETE);
	}
	else {
		*(gint*)(data->user_data+20)+=CHAN_addr(_IO24,0x115);
		*(gint*)(data->user_data+20)+=CHAN_setByte(_IO24,(uint8_t)value);
	}
	return TRUE;
}
...
gboolean scale13_value_changed_cb(GtkWidget * p_wid, gpointer p_data) {
	...
	value2=(uint8_t)value;
	if (*(gint*)(data->user_data+8)==-1) {															// If deamonized access mode (mySlot!=-1).
		*(gint*)(data->user_data+20)+=CHAND_setPRECISE(*(gint*)(data->user_data+12),_IO24,0x114,_DEXEC_COMPLETE);
		*(gint*)(data->user_data+20)+=CHAND_writeBYTES(*(gint*)(data->user_data+12),_IO24,1,(uint8_t*)&value2,_DEXEC_COMPLETE);
	}
	else {
		*(gint*)(data->user_data+20)+=CHAN_addr(_IO24,0x114);
		*(gint*)(data->user_data+20)+=CHAN_setByte(_IO24,(uint8_t)value);
	}
	return TRUE;
}
...
gboolean scale12_value_changed_cb(GtkWidget * p_wid, gpointer p_data) {
	...
	value2=(uint8_t)value;
	if (*(gint*)(data->user_data+8)==-1) {															// If deamonized access mode (mySlot!=-1).
		*(gint*)(data->user_data+20)+=CHAND_setPRECISE(*(gint*)(data->user_data+12),_IO24,0x113,_DEXEC_COMPLETE);
		*(gint*)(data->user_data+20)+=CHAND_writeBYTES(*(gint*)(data->user_data+12),_IO24,1,(uint8_t*)&value2,_DEXEC_COMPLETE);
	}
	else {
		*(gint*)(data->user_data+20)+=CHAN_addr(_IO24,0x113);
		*(gint*)(data->user_data+20)+=CHAN_setByte(_IO24,(uint8_t)value);
	}
	return TRUE;
}
...
gboolean scale11_value_changed_cb(GtkWidget * p_wid, gpointer p_data) {
	...
	value2=(uint8_t)value;
	if (*(gint*)(data->user_data+8)==-1) {															// If deamonized access mode (mySlot!=-1).
		*(gint*)(data->user_data+20)+=CHAND_setPRECISE(*(gint*)(data->user_data+12),_IO24,0x112,_DEXEC_COMPLETE);
		*(gint*)(data->user_data+20)+=CHAND_writeBYTES(*(gint*)(data->user_data+12),_IO24,1,(uint8_t*)&value2,_DEXEC_COMPLETE);
	}
	else {
		*(gint*)(data->user_data+20)+=CHAN_addr(_IO24,0x112);
		*(gint*)(data->user_data+20)+=CHAN_setByte(_IO24,(uint8_t)value);
	}
	return TRUE;
}
...
gboolean scale10_value_changed_cb(GtkWidget * p_wid, gpointer p_data) {
	...
	value2=(uint8_t)value;
	if (*(gint*)(data->user_data+8)==-1) {															// If deamonized access mode (mySlot!=-1).
		*(gint*)(data->user_data+20)+=CHAND_setPRECISE(*(gint*)(data->user_data+12),_IO24,0x111,_DEXEC_COMPLETE);
		*(gint*)(data->user_data+20)+=CHAND_writeBYTES(*(gint*)(data->user_data+12),_IO24,1,(uint8_t*)&value2,_DEXEC_COMPLETE);
	}
	else {
		*(gint*)(data->user_data+20)+=CHAN_addr(_IO24,0x111);
		*(gint*)(data->user_data+20)+=CHAN_setByte(_IO24,(uint8_t)value);
	}
	return TRUE;
}
...
gboolean scale9_value_changed_cb(GtkWidget * p_wid, gpointer p_data) {
	...
	value2=(uint8_t)value;
	if (*(gint*)(data->user_data+8)==-1) {															// If deamonized access mode (mySlot!=-1).
		*(gint*)(data->user_data+20)+=CHAND_setPRECISE(*(gint*)(data->user_data+12),_IO24,0x110,_DEXEC_COMPLETE);
		*(gint*)(data->user_data+20)+=CHAND_writeBYTES(*(gint*)(data->user_data+12),_IO24,1,(uint8_t*)&value2,_DEXEC_COMPLETE);
	}
	else {
		*(gint*)(data->user_data+20)+=CHAN_addr(_IO24,0x110);
		*(gint*)(data->user_data+20)+=CHAN_setByte(_IO24,(uint8_t)value);
	}
	return TRUE;
}
...
gboolean scale8_value_changed_cb(GtkWidget * p_wid, gpointer p_data) {
	...
	value2=(uint8_t)value;
	if (*(gint*)(data->user_data+8)==-1) {															// If deamonized access mode (mySlot!=-1).
		*(gint*)(data->user_data+20)+=CHAND_setPRECISE(*(gint*)(data->user_data+12),_IO24,0x10F,_DEXEC_COMPLETE);
		*(gint*)(data->user_data+20)+=CHAND_writeBYTES(*(gint*)(data->user_data+12),_IO24,1,(uint8_t*)&value2,_DEXEC_COMPLETE);
	}
	else {
		*(gint*)(data->user_data+20)+=CHAN_addr(_IO24,0x10F);
		*(gint*)(data->user_data+20)+=CHAN_setByte(_IO24,(uint8_t)value);
	}
	return TRUE;
}
...
gboolean scale7_value_changed_cb(GtkWidget * p_wid, gpointer p_data) {
	...
	value2=(uint8_t)value;
	if (*(gint*)(data->user_data+8)==-1) {															// If deamonized access mode (mySlot!=-1).
		*(gint*)(data->user_data+20)+=CHAND_setPRECISE(*(gint*)(data->user_data+12),_IO24,0x10E,_DEXEC_COMPLETE);
		*(gint*)(data->user_data+20)+=CHAND_writeBYTES(*(gint*)(data->user_data+12),_IO24,1,(uint8_t*)&value2,_DEXEC_COMPLETE);
	}
	else {
		*(gint*)(data->user_data+20)+=CHAN_addr(_IO24,0x10E);
		*(gint*)(data->user_data+20)+=CHAN_setByte(_IO24,(uint8_t)value);
	}
	return TRUE;
}
...
gboolean scale6_value_changed_cb(GtkWidget * p_wid, gpointer p_data) {
	...
	value2=(uint8_t)value;
	if (*(gint*)(data->user_data+8)==-1) {															// If deamonized access mode (mySlot!=-1).
		*(gint*)(data->user_data+20)+=CHAND_setPRECISE(*(gint*)(data->user_data+12),_IO24,0x10D,_DEXEC_COMPLETE);
		*(gint*)(data->user_data+20)+=CHAND_writeBYTES(*(gint*)(data->user_data+12),_IO24,1,(uint8_t*)&value2,_DEXEC_COMPLETE);
	}
	else {
		*(gint*)(data->user_data+20)+=CHAN_addr(_IO24,0x10D);
		*(gint*)(data->user_data+20)+=CHAN_setByte(_IO24,(uint8_t)value);
	}
	return TRUE;
}
...
gboolean scale5_value_changed_cb(GtkWidget * p_wid, gpointer p_data) {
	...
	value2=(uint8_t)value;
	if (*(gint*)(data->user_data+8)==-1) {															// If deamonized access mode (mySlot!=-1).
		*(gint*)(data->user_data+20)+=CHAND_setPRECISE(*(gint*)(data->user_data+12),_IO24,0x10C,_DEXEC_COMPLETE);
		*(gint*)(data->user_data+20)+=CHAND_writeBYTES(*(gint*)(data->user_data+12),_IO24,1,(uint8_t*)&value2,_DEXEC_COMPLETE);
	}
	else {
		*(gint*)(data->user_data+20)+=CHAN_addr(_IO24,0x10C);
		*(gint*)(data->user_data+20)+=CHAN_setByte(_IO24,(uint8_t)value);
	}
	return TRUE;
}
...
gboolean scale4_value_changed_cb(GtkWidget * p_wid, gpointer p_data) {
	...
	//printf("value = %d \n",(uint8_t*)&value);
	if (*(gint*)(data->user_data+8)==-1) {															// If deamonized access mode (mySlot!=-1).
		*(gint*)(data->user_data+20)+=CHAND_setPRECISE(*(gint*)(data->user_data+12),_IO24,0x10B,_DEXEC_COMPLETE);
		*(gint*)(data->user_data+20)+=CHAND_writeBYTES(*(gint*)(data->user_data+12),_IO24,1,&value2,_DEXEC_COMPLETE);
	}
	else {
		*(gint*)(data->user_data+20)+=CHAN_addr(_IO24,0x10B);
		*(gint*)(data->user_data+20)+=CHAN_setByte(_IO24,(uint8_t)value);
	}
	return TRUE;
}
...
gboolean scale3_value_changed_cb(GtkWidget * p_wid, gpointer p_data) {
	...
	value2=(uint8_t)value;
	if (*(gint*)(data->user_data+8)==-1) {															// If deamonized access mode (mySlot!=-1).
		*(gint*)(data->user_data+20)+=CHAND_setPRECISE(*(gint*)(data->user_data+12),_IO24,0x10A,_DEXEC_COMPLETE);
		*(gint*)(data->user_data+20)+=CHAND_writeBYTES(*(gint*)(data->user_data+12),_IO24,1,(uint8_t*)&value2,_DEXEC_COMPLETE);
	}
	else {
		*(gint*)(data->user_data+20)+=CHAN_addr(_IO24,0x10A);
		*(gint*)(data->user_data+20)+=CHAN_setByte(_IO24,(uint8_t)value);
	}
	return TRUE;
}
...
gboolean scale2_value_changed_cb(GtkWidget * p_wid, gpointer p_data) {
	...
	value2=(uint8_t)value;
	if (*(gint*)(data->user_data+8)==-1) {															// If deamonized access mode (mySlot!=-1).
		*(gint*)(data->user_data+20)+=CHAND_setPRECISE(*(gint*)(data->user_data+12),_IO24,0x109,_DEXEC_COMPLETE);
		*(gint*)(data->user_data+20)+=CHAND_writeBYTES(*(gint*)(data->user_data+12),_IO24,1,(uint8_t*)&value2,_DEXEC_COMPLETE);
	}
	else { 
		*(gint*)(data->user_data+20)+=CHAN_addr(_IO24,0x109);
		*(gint*)(data->user_data+20)+=CHAN_setByte(_IO24,(uint8_t)value);
	}
	return TRUE;
}
...
gboolean scale1_value_changed_cb(GtkWidget * p_wid, gpointer p_data) {
	...
	value2=(uint8_t)value;
	if (*(gint*)(data->user_data+8)==-1) {		// If deamonized access mode (mySlot!=-1).
		*(gint*)(data->user_data+20)+=CHAND_setPRECISE(*(gint*)(data->user_data+12),_IO24,0x108,_DEXEC_COMPLETE);
		*(gint*)(data->user_data+20)+=CHAND_writeBYTES(*(gint*)(data->user_data+12),_IO24,1,(uint8_t*)&value2,_DEXEC_COMPLETE);
	}
	else {
		*(gint*)(data->user_data+20)+=CHAN_addr(_IO24,0x108);
		*(gint*)(data->user_data+20)+=CHAN_setByte(_IO24,(uint8_t)value);
	}
	return TRUE;
}
...
gboolean button18_clicked_cb(GtkWidget * p_wid, gpointer p_data) {
	SGlobalData *data =(SGlobalData*) p_data;
	...
	if (*(gint*)(data->user_data+8)==-1) {															// If deamonized access mode (mySlot!=-1).
			*(gint*)(data->user_data+20)+=CHAND_setPRECISE(*(gint*)(data->user_data+12),_IO24,myTXBuffer[16],_DEXEC_COMPLETE);	//
			*(gint*)(data->user_data+20)+=CHAND_writeBYTES(*(gint*)(data->user_data+12),_IO24,16,myTXBuffer,_DEXEC_COMPLETE);		// Write user sequence in free RAM.
			* (gint*)(data->user_data+20)+=CHAND_setPRECISE(*(gint*)(data->user_data+12),_IO24,0x118,_DEXEC_COMPLETE);			//
			*(gint*)(data->user_data+20)+=CHAND_writeBYTES(*(gint*)(data->user_data+12),_IO24,1,&myTXBuffer[16],_DEXEC_COMPLETE);// Write PWM_SEQ_INDEX value @ 0x108.
		}
		else {	
			*(gint*)(data->user_data+20)+=CHAN_addr(_IO24,myTXBuffer[16]);								//
			*(gint*)(data->user_data+20)+=CHAN_setBytes(_IO24,16,myTXBuffer);							// Write user sequence in free RAM.
			*(gint*)(data->user_data+20)+=CHAN_addr(_IO24,0x118);										//
			*(gint*)(data->user_data+20)+=CHAN_setBytes(_IO24,1,&myTXBuffer[16]);						// Write PWM_SEQ_INDEX value @ 0x118.
	}		
	return TRUE;
}
...
gboolean entry17_changed_cb(GtkWidget * p_wid, gpointer p_data) {      										// Entries editing.
	...
	entry[14]=GTK_ENTRY(gtk_builder_get_object(data->builder,"entry15"));
	entry[15]=GTK_ENTRY(gtk_builder_get_object(data->builder,"entry16"));
	button=GTK_BUTTON(gtk_builder_get_object(data->builder,"button18"));
	ptr=gtk_entry_get_text(GTK_ENTRY(p_wid));
	do 
	{
		str[n]=*ptr;
	...
	if (*(gint*)(data->user_data+8)==-1) {															// If deamonized access mode (mySlot!=-1).
		* (gint*)(data->user_data+20)+=CHAND_setPRECISE(*(gint*)(data->user_data+12),_IO24,value,_DEXEC_COMPLETE);			//
		*(gint*)(data->user_data+20)+=CHAND_writeBYTES(*(gint*)(data->user_data+12),_IO24,16,&myRXBuffer[0],_DEXEC_COMPLETE);// Write PWM_SOURCE value @ 0x119.
	}
	else {
		*(gint*)(data->user_data+20)+=CHAN_addr(_IO24,value);										//
		*(gint*)(data->user_data+20)+=CHAN_getBytes(_IO24,16,&myRXBuffer[0]);
	}
	for (i=0;i<16;i++) {
...
gboolean checkbutton1_toggled_cb(GtkWidget * p_wid, gpointer p_data) {
	...
	if (gtk_toggle_button_get_active(GTK_TOGGLE_BUTTON(p_wid))) {
		source=1;
		if (*(gint*)(data->user_data+8)==-1) {															// If deamonized access mode (mySlot!=-1).
			* (gint*)(data->user_data+20)+=CHAND_setPRECISE(*(gint*)(data->user_data+12),_IO24,0x119,_DEXEC_COMPLETE);			//
			*(gint*)(data->user_data+20)+=CHAND_writeBYTES(*(gint*)(data->user_data+12),_IO24,1,&source,_DEXEC_COMPLETE);// Write PWM_SOURCE value @ 0x119.
		}
		else {
			*(gint*)(data->user_data+20)+=CHAN_addr(_IO24,0x119);										//
			*(gint*)(data->user_data+20)+=CHAN_setByte(_IO24,1);										// Write PWM_SOURCE value @ 0x119.
		}		
	}
	else {
		source=0;
		if (*(gint*)(data->user_data+8)==-1) {															// If deamonized access mode (mySlot!=-1).
			...
			*(gint*)(data->user_data+20)+=CHAN_addr(_IO24,0x119);										//
			*(gint*)(data->user_data+20)+=CHAN_setByte(_IO24,0);										// Write PWM_SOURCE value @ 0x119.
		}		
	}
...
gboolean togglebutton1_toggled_cb(GtkWidget * p_wid, gpointer p_data) {
	...
	if (gtk_toggle_button_get_active (GTK_TOGGLE_BUTTON(p_wid))) {
		...
		//if (*(gint*)(data->user_data+8)==-1) *(gint*)(data->user_data+20)+=CHAND_doCOMMAND(*(gint*)(data->user_data+12),_IO24,0x05,_DEXEC_COMPLETE);			// If deamonized access mode (mySlot!=-1).
		//else *(gint*)(data->user_data+20)+=CHAN_command(_IO24,0x05);
		*(gint*)(data->user_data+20)+=CHAN_command(_IO24,0x05);
	}
	else {
		gtk_label_set_text(label,"Servos are OFF.");
		//if (*(gint*)(data->user_data+8)==-1) *(gint*)(data->user_data+20)+=CHAND_doCOMMAND(*(gint*)(data->user_data+12),_IO24,0x01,_DEXEC_COMPLETE);			// If deamonized access mode (mySlot!=-1).
		//else *(gint*)(data->user_data+20)+=CHAN_command(_IO24,0x01);
		*(gint*)(data->user_data+20)+=CHAN_command(_IO24,0x06);
	}
	return TRUE;
}
...
void setCheckConf_cb(GtkWidget * p_wid,gpointer p_data) {											// checkbutton "warn me ...." callback in preferences popup window
	...
	uint8_t* ptr=NULL; 
	int8_t str[100]="";
	fd = fopen("../chgtkt/chgtkt.conf", "rb+");
	if (fd != NULL) {
		do {
...
void comboboxtext1_changed_cb(GtkWidget * p_wid,gpointer p_data) {
	...
	if (line) {
		line[4]='\0';
		sscanf((const char*)line,"%d",(int *)&IO24num);
		printf("IO24num=%d\n",IO24num);
	}
}
...
void window1_realize_cb3(GtkWidget * p_wid,gpointer p_data) {
	...
	if (*(gint*)(data->user_data+8)==-1) {
		for (m=1;m<8;m++) {
			...
			CHAND_getCOREINFO(m,(uint8_t*)&chantilly_stack);
...
void window1_realize_cb2(GtkWidget * p_wid,gpointer p_data) {
	...
	scale[15]=GTK_SCALE(gtk_builder_get_object(data->builder,"scale16"));
	if (*(gint*)(data->user_data+8)==-1) {															// If deamonized access mode (mySlot!=-1).
		*(gint*)(data->user_data+20)+=CHAND_setADDR(*(gint*)(data->user_data+12),_IO24,0x42,_DEXEC_COMPLETE);
		*(gint*)(data->user_data+20)+=CHAND_readBYTES(*(gint*)(data->user_data+12),_IO24,18,&myRXBuffer[0],_DEXEC_COMPLETE);
	}
	else {
		*(gint*)(data->user_data+20)+=CHAN_addr(_IO24,0x108);
		*(gint*)(data->user_data+20)+=CHAN_getBytes(_IO24,18,&myRXBuffer[0]);
	}
...
int main(int argc, char **argv)
{
	...
	filename =  g_build_filename ("/home/pi/code_004/TESTS/chgservo/chgservo.glade", NULL);
